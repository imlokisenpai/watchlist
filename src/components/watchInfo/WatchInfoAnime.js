                ...
                <div className="data">
                    ...
                    <div className="info">
                        ...
                        <div className="seasonDiv">
                            ...
                            <div className="boxedDiv animated d3">
                                <div><h3 className="subtitle boxedDivMargin">OVAs</h3></div>
                                <div className="infoSize"><p>{this.state.ovas}</p></div>
                            </div>
                            <div className="boxedDiv animated d3">
                                <div><h3 className="subtitle boxedDivMargin">Movies</h3></div>
                                <div className="infoSize"><p>{this.state.movies}</p></div>
                            </div>
                        </div>
